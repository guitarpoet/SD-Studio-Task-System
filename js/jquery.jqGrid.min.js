...
0?p:0;V=a(t).jqGrid("getInd",c);a(t.p.colModel).each(function(y){M=this.name;z=false;$=(N=this.editrules&&this.editrules.edithidden===true?false:true/*--Jack - For hidden - this.hidden===true?true:false*/)?"style='display:none'":"";A=typeof this.viewable!="boolean"?true:this.viewable;if(M!=="cb"&&M!=="subgrid"&&M!=="rn"&&A){T=V===false?"":M==t.p.ExpandColumn&&t.p.treeGrid===true?a("td:eq("+y+")",t.rows[V]).text():a("td:eq("+y+")",t.rows[V]).html();z=this.align==="right"&&E!==0?true:false;a.extend({},this.editoptions||{},{id:M,
